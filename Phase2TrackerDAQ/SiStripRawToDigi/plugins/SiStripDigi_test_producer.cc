...
namespace sistrip {
  ...
  SiStripDigi_test_producer::SiStripDigi_test_producer( const edm::ParameterSet& pset ) :
    runNumber_(0),
  ...
  SiStripDigi_test_producer::~SiStripDigi_test_producer()
  {
  }
  
  void SiStripDigi_test_producer::beginJob( const edm::EventSetup & )
  {
  }
  
  void SiStripDigi_test_producer::beginRun( edm::Run & run, const edm::EventSetup & es)
  {
  }
  
  void SiStripDigi_test_producer::endJob()
  {
  }
  
  void SiStripDigi_test_producer::produce( edm::Event& event, const edm::EventSetup& es)
  {
	...
	ss << " -------------------------------------------- " << endl;
        LogTrace("SiStripDigi_test_producer") << ss.str(); ss.clear(); ss.str("");
